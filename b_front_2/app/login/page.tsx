      ...
      <div className="flex-1 bg-[#F3F4F6] flex items-center justify-center px-8">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            ...
            <p className="text-[#C7C7C7]">Войдите в свой аккаунт</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link href="/forgot-password" className="text-sm text-[#3D6D56] hover:underline transition-colors">
                Забыли пароль?
              </Link>
            </div>
          ...
          <div className="text-center space-y-4">
            ...
            <div className="pt-4 border-t border-[#F3F4F6]">
              <Link href="/admin/login" className="text-sm text-[#C7C7C7] hover:text-[#3D6D56] transition-colors">
