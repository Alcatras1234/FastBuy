...
public class EmailService {
    ...
    @Autowired
    public EmailService(OTGPasswordRepository otgPasswordRepository) {
    ...
    public void sendEmailForVerify(String email) {
        ...
        String from = "danial.bakirov@gmail.com";
        String password = "rzga aysa irrt ywtu";
    ...
    public boolean checkOTGPassword(String password) {
        if (otgPasswordRepository.findOTGPasswordByOtgpassword(password) != null) {
            otgPasswordRepository.deleteOTGPassword(password);
            return true;
        } else {
            return false;
        }
